...
CREATE TABLE `guild_permissions` (
  ...
  KEY `FK_guild_permission_type` (`permission_type`),
  KEY `FK_guild_character` (`character_id`),
  CONSTRAINT `FK_guild_permission_type` FOREIGN KEY (`permission_type`) REFERENCES `guild_permission_types` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
